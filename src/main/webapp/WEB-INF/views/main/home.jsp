                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post wow fadeInUp" data-wow-delay=".4s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                	<a href="/jeju/detail_before?contentid=${jvo.contentid }&contenttype=${jvo.contenttype}">
                                    <img src="${jvo.image1 }" style="width:340px;height:235px;">
                                    </a>
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                                        <div class="post-author-date-area d-flex">
                                            <!-- Post Author -->
                                            <div class="post-author">
                                                <a href="/jeju/detail_before?contentid=${jvo.contentid }&contenttype=${jvo.contenttype}">${jvo.address }</a>
                                            </div>
                                            <!-- Post Date -->
                                            <div class="post-date">
                                                <a href="/jeju/detail_before?contentid=${jvo.contentid }&contenttype=${jvo.contenttype}">${jvo.hit }</a>
                                            </div>
                                        </div>
                                        <!-- Post Comment & Share Area -->
                                        <div class="post-comment-share-area d-flex">
                                ...
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                                        <div class="post-author-date-area d-flex">
                                            <!-- Post Author -->
                                            <div class="post-author">
                                                <a href="/busan/detail_before?contentid=${vo.contentid }&contenttype=${vo.contenttype}">${vo.avo.usetime }</a>
                                            </div>
                                            <!-- Post Date -->
                                            <div class="post-date">
                                                <a href="/busan/detail_before?contentid=${vo.contentid }&contenttype=${vo.contenttype}">${vo.hit }</a>
                                            </div>
                                        </div>
                                        <!-- Post Comment & Share Area -->
                                        <div class="post-comment-share-area d-flex">
                                            ...
                                            <!-- Post Share -->
                                            <div class="post-share">
                                                <a href="/busan/detail_before?contentid=${vo.contentid }&contenttype=${vo.contenttype}"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="/busan/detail_before?contentid=${vo.contentid }&contenttype=${vo.contenttype}">
                                    ...
                                    <p>${vo.address }</p>
                                    <a href="/busan/detail_before?contentid=${vo.contentid }&contenttype=${vo.contenttype}" class="read-more">Continue Reading..</a>
                                </div>
                            </div>
                        </div>
						</c:forEach>
