                            ...
                            <div class="post-meta d-flex">
                                <div class="post-author-date-area d-flex">
                                    ...
                                    <div class="post-author">
                                        <a :href="`/seoul/detail_before?contentid=`+vo.contentid+`&contenttype=`+vo.contenttype">{{vo.address}}</a>
                                    </div>
<!--                                     Post Date
                                    <div class="post-date">
                                        <a href="#">-</a>
                                ...
                                <div class="post-comment-share-area d-flex">
                                    ...
                                    <div class="post-favourite">
                                        <a :href="`/seoul/detail_before?contentid=`+vo.contentid+`&contenttype=`+vo.contenttype"><i class="fa fa-heart-o" aria-hidden="true"></i> 10</a>
                                    </div>
                                    <!-- Post Comments -->
                                    <div class="post-comments">
                                        <a :href="`/seoul/detail_before?contentid=`+vo.contentid+`&contenttype=`+vo.contenttype"><i class="fa fa-comment-o" aria-hidden="true"></i> 12</a>
                                    </div>
                                    <!-- Post Share -->
