                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/board/detail?no=${vo.no }"><i class="fa fa-home" aria-hidden="true"></i> ${vo.subject }</a></li>
                            <li class="breadcrumb-item active" aria-current="page">수정 하기</li>
                        </ol>
                    </nav>
                </div>
            </div>
            	...
            	<table class="table">
            		<tbody>
            			...
            			<tr>
            				...
            				<td width="85%" class="text-left">
            					<textarea rows=10 cols= 60 name=content required style="resize:none">${vo.content }</textarea>
            				</td>
            			</tr>
            			<tr>
            			...
            			<tr>
            				<td class="text-center" colspan=2>
            					<a href="/board/detail?no=${vo.no }" class="btn btn-sm btn-primary">취소</a>
